    ...
    function ensureBadgesStyleInjected() {
        ...
        try {
            var css = ''
                ...
                // Фикс прыжка от lazy-load: фиксируем размер cards и рядов.
                // em-единицы автоматически масштабируются под TV-font-size.
                + '.trakt_v3 .items-line,.trakt_v3 [class*="items-line"]{min-height:30em !important;}'
                + '.trakt_v3 .items-line__body{min-height:26em !important;}'
                // Card-view: фиксированная высота в em (масштабируется с font-size TV).
                // Перебивает любой aspect-shift при подгрузке постеров разных размеров.
                + '.trakt_v3 .card .card__view{height:21em !important;}';
